...
public class Productos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        OpListado = new javax.swing.JMenuItem();
        ...
        OpListado.setText("Ver listado productos ");
        OpListado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                OpListadoActionPerformed(evt);
            }
        });
        opcProductos.add(OpListado);

        OpAgg.setText("Agregar un nuevo producto");
        opcProductos.add(OpAgg);

        OpInventario.setText("Inventario de productos");
        opcProductos.add(OpInventario);

        jMenuBar1.add(opcProductos);
    ...
    private void OpListadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OpListadoActionPerformed
        // TODO add your handling code here:
         //metodo para llamar la ventana ListaProductos en el escritorio
        ListaProductos viewWindow = new ListaProductos();
        escritorio.add(viewWindow);
        viewWindow.show();
    }//GEN-LAST:event_OpListadoActionPerformed
    ...
    private javax.swing.JMenuItem OpListado;
